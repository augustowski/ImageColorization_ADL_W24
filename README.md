...
To ensure that everyone could try the application, I decided to use HuggingFace Spaces, so it becomes accessible right from link. This link will lead you to the application - [HuggingsFace Spaces Apllication link](https://huggingface.co/spaces/augustowski/image_colorization_app2). 
